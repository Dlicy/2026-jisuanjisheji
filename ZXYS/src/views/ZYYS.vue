        ...
        <div class="medicine-list">
          ...
          >
            <div class="medicine-header">
              ...
              <div class="medicine-source">{{ medicine.Source }}</div>
            </div>
          </div>
          ...
          <div class="detail-panel-content">
            <div class="detail-panel-header">
              <div>
                ...
                <div class="detail-panel-source">{{ currentMedicine?.Source || '' }}</div>
              </div>
            ...
            <div class="detail-section">
              <div class="detail-title">配方</div>
              <div class="ingredient-grid">
                <div
                  v-for="(ing, idx) in currentMedicine?.Ingredient || []"
                  :key="idx"
                  class="ingredient-card"
                >
                  <span class="ingredient-name">{{ ing.FoodName }}</span>
                  <span class="ingredient-amount"
                    >{{ ing.Amount }} {{ unitMap[ing.Unit] || '' }}</span
                  >
                </div>
              </div>
            </div>
            ...
            <!-- 做法区域 -->
            <div class="detail-section">
              <div class="detail-title">做法</div>
              <div class="detail-text" v-html="currentMedicine?.Recipe || ''"></div>
            </div>

            <!-- 功效区域 -->
            <div class="detail-section">
              <div class="detail-title">功效</div>
              <div class="detail-text" v-html="currentMedicine?.efficacy || ''"></div>
            </div>
          </div>
        </div>
      </div>
...
const filteredData = computed(() => {
  ...
  return medicineData.value.filter((medicine) =>
...
const loadMedicineData = async () => {
  try {
    loading.value = true
    const response = await fetch('/ZYYS/data.json')
    const data = await response.json()
    medicineData.value = data
  } catch (error) {
    console.error('加载药膳数据失败:', error)
  } finally {
    loading.value = false
  }
}
...
.medicine-item {
  background-image: url('/public/ZYYS/ZYYSBg.png');
