...
export const DEFAULT_AVATAR_CONFIG: AvatarConfig = {
  appId: 'ad6e83bbe0ca46bb9a14d07a228b60f2',
  appSecret: 'd2029589b6884833b125d2a45c2afbf6',
}

export const DEFAULT_ASR_CONFIG: Partial<AsrConfig> = {
  provider: 'xf',
  appId: '2120ac8d',
  secretId: '20bedfd7420cc3a1e691d50730eff1f2',
  secretKey: 'MWNjZmY5ZWMwYWE1NzlmODE5NjBjNWMw',
  vadSilenceTime: 2000,
...
export const DEFAULT_LLM_CONFIG: Partial<LlmConfig> = {
  provider: 'deepseek',
  model: 'deepseek-chat',
  apiKey: 'sk-077f5dce94ae4cce862b539df071b462',
  temperature: 0.7,
  maxTokens: 4000,
}
